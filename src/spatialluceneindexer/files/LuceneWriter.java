...
public class LuceneWriter {
    ...
    public void addPark(Tweet tweet){
        Document doc = new Document();
        
        doc.add(new TextField("text", tweet.getText(), Field.Store.YES));
        doc.add(new TextField("user", tweet.getUser(), Field.Store.YES));
        doc.add(new TextField("id", tweet.getId(), Field.Store.YES));
        doc.add(new TextField("created_at", tweet.getCreated_at(), Field.Store.YES));
        ...
        /*Shape pointShape = spatialContext.makePoint(Double.parseDouble(tweet.getUser(),Integer.parseInt(tweet.getId())));
